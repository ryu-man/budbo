		...
		<div className="budbo-app flex flex-col">
			...
			<div className="flex flex-col gap-10">
				<Paper>
					<div className="flex flex-col">
						...
						<p className="text-black">
							Without further delay and with great honor, we introduce the Budbo
							ecosystem:
						</p>
						...
						<PaperSection className="border-b">
							...
							<p>
								...
								dispensaries, order cannabis, and earn cryptocurrency rewards.
							</p>

							<div className="mb-12"></div>

							<div className="relative">
								<Image src={ReasonOneImage} alt="Green label" />
						...
						<PaperSection className="border-b">
							...
							<p>
								SaaS for grass! Business intelligence tools for dispensaries and
								brands, providing effortless e-commerce management, proactive
						...
						<PaperSection className="border-b">
							...
							<p>
								...
								supply chain including continuity of product, chain of custody,
								and fleet management for businesses.
							</p>

							<div className="mb-12"></div>

							<Image src={TraxBackgroundImage} alt="Trax background image" />
						</PaperSection>
						...
						<PaperSection className="border-b">
							...
							<p>
								&quot;Tinder&quot; for buying weed - we did that! Quickly swipe
								through 1000&apos;s of locally available strains and products to
						...
						<PaperSection className="border-b">
							...
							<p>
								Nothing is more important to Budbo than our community of users.
								It is our north star, guiding everything we do.
								<br /> <br />
								By joining Budbo, users immedialtely begin earning
								<span className="text-primary">Budbo Token(BUBO)</span> rewards.
								Equipped with a token dashboard, users can track their rewards
								and learn about cryptocurrency and blockchain.
							</p>
						...
						<div>
							...
							<Gallery>
								<GalleryItem size="lg" src={Gallery1Image} alt="Gallery item" />
								<GalleryItem size="lg" src={Gallery2Image} alt="Gallery item" />
								...
								<GalleryItem size="lg" src={Gallery9Image} alt="Gallery item" />
								<GalleryItem
									size="lg"
									src={Gallery10Image}
									alt="Gallery item"
					...
					<div className="flex flex-col gap-12">
						<div className="flex flex-col gap-6">
							...
							<div className="font-bold text-xl">
								...
								was built for app users, dispensaries, growers, and brands to
								earn tokens simply by using Budbo.
							</div>
						...
						<div className="flex flex-col gap-6">
							...
							<p>
								To keep costs in check and transactions at near-instant speeds,
								Budbo utilizes the Polygon scaling solution. Our partners at
								Polygon(Symbol: MATIC) are the very best in their assistance
								with the development of these protocols.
							</p>
						</div>
						...
						<div className="flex flex-col gap-6">
							...
							<div className="font-bold text-xl">
								...
								<span className="text-primary"> swap and pool protocols.</span>
							</div>
							...
							<p>
								...
								<span className="font-bold text-black">
									allows end-users and cannabis businesses to enjoy the benefits
									of blockchain
								</span>{" "}
				...
				<Paper>
					...
					<div className="mb-12">
						<h6 className="text-rum-700">Driven, by passion and experience.</h6>
						<h3>
					...
					<p>
						...
						trained doctors, cannabis industry veterans, and seasoned financial
						executives.
					</p>
